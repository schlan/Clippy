...
public class NotificationHelper {
    ...
    public static Notification getNotification(Context context, AgentType agentType, boolean isRunning, boolean isMute){
        ...
        return new NotificationCompat.Builder(context)
                ...
                .setStyle(new NotificationCompat.BigTextStyle().bigText("Clippy big text"))

                .addAction(startStopDrawable, "Start/Stop", startStopPending)
                .addAction(muteUnmuteDrawable, "Mute/Unmute", muteUnmutePending)
